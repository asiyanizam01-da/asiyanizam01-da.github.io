...
// =====================================================
// CERTIFICATION CATEGORY TOGGLES
// =====================================================
...
<span class="cert-status-badge cert-complete">
                        Completed
                    </span>
                </div>
            ...
            <ul class="cert-modules cdp-modules">
                ${moduleLis}
            </ul>
 ...
 viewerDiv.innerHTML = buildInlineViewer(
    ...
    function closeCertDetail() {
        ...
        // Clear iframe when closing popup
        certDetailInner.innerHTML = '';
    }
// =====================================================
    // EVENT BINDINGS
